...
function Faq() {
    ...
    <div className="container my-5">
        <div className="row my-5">
            <div className="col-md-12 text-center">
                <h1 className='text-white'>Fa<span style={{color: '#f4a910'}}>Q</span></h1>
            </div>
        </div>
        <div className="row">
  ...
  <div className="accordion-item">
    ...
    <div id="flush-collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div className="accordion-body" style={{color: '#f4a910', letterSpacing: '1.3px',lineHeight: '1.8rem'}}>Ambitious Trainings Institute offers a variety of courses including professional <code>development programs</code>, technical skill enhancement, certifications in various fields such as IT, <code> business management</code>, <code>digital marketing</code>, and more. We also provide specialized training for different industries and tailored programs for corporate clients.</div>
    </div>
  </div>
  <div className="accordion-item">
    <h2 className="accordion-header">
    ...
    <div id="flush-collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div className="accordion-body" style={{color: '#f4a910', letterSpacing: '1.3px',lineHeight: '1.8rem'}}>To enroll in a course, visit our website and navigate to the "Courses" section. Select the course you’re interested in and follow the instructions to <code>register</code>. Alternatively, you can contact our admissions office via phone or email for assistance with the <code>enrollment</code> process.</div>
    </div>
  </div>
  <div className="accordion-item">
    <h2 className="accordion-header">
    ...
    <div id="flush-collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div className="accordion-body" style={{color: '#f4a910',letterSpacing: '1.3px',lineHeight: '1.8rem'}}>Our instructors are highly qualified professionals with extensive experience in their respective fields. They hold advanced degrees, relevant certifications, and have practical experience working in industry. Each instructor is selected based on their <code>expertise</code> and ability to effectively teach and <code>engage students</code>.</div>
    </div>
  </div>
  <div className="accordion-item">
    <h2 className="accordion-header">
    ...
    <div id="flush-collapseFour" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div className="accordion-body" style={{color: '#f4a910',letterSpacing: '1.3px',lineHeight: '1.8rem'}}>Yes, <code>Ambitious Trainings Institute</code> offers a range of scholarships and financial aid options to eligible students. These include merit-based scholarships, need-based financial assistance, and corporate sponsorships. Visit our website or contact our financial aid office for more information on available options and application procedures.</div>
    </div>
  </div>
  <div className="accordion-item">
    <h2 className="accordion-header">
